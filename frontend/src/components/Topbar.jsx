...
import brightIcon from "../../public/icons/bright_2.png";
...
export default function Topbar() {
  ...
  const modeIconSrc = mode === "dark" ? brightIcon : darkIcon;
  ...
  return (
    <header className="sticky top-0 z-30 border-b border-ui-border bg-ui-surface/90 backdrop-blur">
      <div className="mx-auto flex w-full items-center justify-between px-4 py-3 sm:px-6 lg:px-8">
        ...
        {/* Espaçamento centralizado aqui em vez de mr-8/ml-4 soltos no
            botão de modo — assim dá pra adicionar mais ícones utilitários
            depois sem reajustar margem em cada um. */}
        <div className="flex items-center gap-2 ml-4 mr-8">
          ...
          <button
            type="button"
            onClick={toggleMode}
            className="inline-flex items-center gap-2 rounded-md border border-ui-border bg-ui-surface-2 px-2.5 py-1.5 text-xs font-medium text-ui-text-secondary transition-colors hover:text-ui-text-primary"
