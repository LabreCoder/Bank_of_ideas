  ...
  theme: {
    extend: {
      colors: {
        ...
        ui: {
          page: "rgb(var(--color-ui-page) / <alpha-value>)",
          surface: "rgb(var(--color-ui-surface) / <alpha-value>)",
          "surface-2": "rgb(var(--color-ui-surface-2) / <alpha-value>)",
          border: "rgb(var(--color-ui-border) / <alpha-value>)",
          "text-primary": "rgb(var(--color-ui-text-primary) / <alpha-value>)",
          "text-secondary": "rgb(var(--color-ui-text-secondary) / <alpha-value>)",
          "text-muted": "rgb(var(--color-ui-text-muted) / <alpha-value>)",
        },
      },
    },
  },
